...
#------------------------------------------------------------------------------
$(name)$(TAIL).exe: $(obj) resource.res
!if $(UseBCC)
  $(linkexe) $(C0GUI) $(obj),$<,$*,$(DebugLib) NOEH32 IMPORT32 CW32,,resource.res
!else
  $(linkexe) $(C0GUI) $(obj) /OUT:$&.exe resource.res
!endif
